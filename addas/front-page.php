...
<?php // 記事一覧 ?>
<div class="container">
	<h2 class="text-center text-primary hidden">インフォメーション</h2>
	<?php
		// $num = 6;
		...
		// wp_reset_query();
	?>
	<div class="hidden"><a href="<?php echo get_permalink(get_page_by_path('news')); ?>" class="btn btn-ghost btn-primary btn-lg btn-block round">最新情報一覧</a></div>
</div>
